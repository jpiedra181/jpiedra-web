...
Si quieres saber qué problemas de accesibilidad tiene tu web de verdad, más allá de lo que diga una herramienta automática, puedo [auditar tu web como acabo de auditar la mía](/auditoria-accesibilidad). Trabajo contra WCAG 2.1 AA y la Ley 11/2023, con cada problema localizado, explicado en lenguaje claro, priorizado y con su solución. Como el que acabas de leer, pero de tu web.