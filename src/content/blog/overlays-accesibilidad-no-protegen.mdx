...
Si has instalado un overlay y ahora no sabes qué hay realmente debajo, el primer paso es averiguarlo. Para eso [hago auditorías de accesibilidad](/auditoria-accesibilidad): te digo, con pruebas, dónde está tu web hoy y qué cuesta dejarla bien. Sin botón flotante.
