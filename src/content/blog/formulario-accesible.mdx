...
Si quieres saber en qué estado están de verdad los formularios de tu web —y el resto—, eso es justo lo que hago: una [auditoría de accesibilidad](/auditoria-accesibilidad) con pruebas manuales de teclado y lector de pantalla, no solo el informe automático de turno. Empezando por donde más te importa, que suele ser por donde te escriben los clientes.
